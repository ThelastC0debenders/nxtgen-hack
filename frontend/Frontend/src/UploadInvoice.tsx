import { 
  ...
  Hash, Building, IndianRupee, Calendar, Play, FileUp
} from 'lucide-react';
        ...
        <div className="bg-white rounded-xl border border-[#e2e8f0] shadow-[0_8px_25px_rgba(71,85,105,0.08)] p-8">
          ...
          <div className="mb-8">
            ...
            <div 
              ...
              className={`border-2 border-dashed rounded-xl py-8 flex flex-col items-center justify-center cursor-pointer transition-colors ${
                submitted ? 'border-[#e2e8f0] bg-[#f8fafc] cursor-not-allowed' :
          ...
          <div className="flex items-center justify-end gap-3 mb-6">
            ...
            <button 
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-lg text-[13px] font-bold tracking-[0.05em] uppercase border-none transition-colors cursor-pointer ${
                !invoiceId || !buyerId || submitted 
